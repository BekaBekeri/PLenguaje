...
public class Machines {
	public static IMooreMachine MeleeEnemy(){
		...
		Andar.setOutput((VendingEnvironment env) -> env.notify("Andar"));
		machine.addState(Andar);
		State Parado = new State("Parado");
		Parado.setOutput((VendingEnvironment env) -> env.notify("Parado"));
		machine.addState(Parado);
		State Atacar = new State("Atacar");
		Atacar.setOutput((VendingEnvironment env) -> env.notify("Atacar"));
		machine.addState(Atacar);
		State Huir = new State("Huir");
		Huir.setOutput((VendingEnvironment env) -> env.notify("Huir"));
